...
class Iterable:
    def __init__(self, max_vectors, max_points):
        ...
        self.max_index = randint(1, max_vectors)
        self.vectors = []
    ...
    def __next__(self):
        if self.current_index <= self.max_index:
            ...
            return Vector(Point(randint(0, self.max_points), randint(0, self.max_points)))
        raise StopIteration
...
class RandomVectors:
    ...
    def __iter__(self):
        return Iterable(self.__max_vectors, self.__max_points)
